...
@section('content')
    ...
    <div class="container mt-3">
        <form action="{{ url('bayar-sekarang') }}" method="POST">
            {{ csrf_field() }}
        <div class="row">
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row checkout-form">
                            <div class="col-md-6">
                                ...
                                <input type="text" required class="form-control name" value="{{ Auth::user()->name }}" name="name" placeholder="First Name">
                                <span id="name_error" class="text-danger"></span>
                            </div>
                            <div class="col-md-6">
                                <label for="firstname">Last Name</label>
                                <input type="text" required class="form-control lname" value="{{ Auth::user()->lname }}" name="lname" placeholder="Last Name">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="text" required class="form-control alamat" value="{{ Auth::user()->alamat }}" name="alamat" placeholder="Enter Address">
                                <span id="alamat_error" class="text-danger"></span>
                            </div>
                            <div class="col-md-6 mt-3">
                                <label for="">Kota</label>
                                <input type="text" required class="form-control kota" value="{{ Auth::user()->kota }}" name="kota" placeholder="Kota">
            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="px-2">Total <span class="float-end"> Rp {{ number_format($total) }}</span></h6>
                        <hr>
                        <input type="hidden" name="payment_mode" value="langsung">
                        <button type="submit" class="btn btn-primary w-100">Bayar Sekarang</button>
                        <button type="button" class="btn btn-success w-100 razorpay_btn">Bayar dengan Razorpay</button>
...
@section('scripts')
    <script src="https://www.paypal.com/sdk/js?client-id=AVbDNzTlYXxfDsL20zFCd6L3DtQjuUp4ym3kE8HktS_JXWrRc3suVL4JMEG9x_HTpJTMIpeQoOUp03gg"></script>
